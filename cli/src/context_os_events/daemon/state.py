...
class DaemonState:
    ...
    last_chain_build: Optional[datetime] = None
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "last_chain_build": self.last_chain_build.isoformat() if self.last_chain_build else None,
    ...
    def from_dict(cls, data: dict) -> "DaemonState":
        ...
        return cls(
            ...
            last_chain_build=parse_datetime(data.get("last_chain_build")),
            ...
            chains_built=data.get("chains_built", 0),
        )
